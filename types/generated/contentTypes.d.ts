...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Artist_PhoneNumber: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    episodes_guest_featured: Schema.Attribute.Relation<
      'manyToMany',
      'api::episode.episode'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEpisodeEpisode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    UploadManually: Schema.Attribute.Boolean &
      Schema.Attribute.Private &
      Schema.Attribute.DefaultTo<false>;
  };
}
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::news.news'> &
      Schema.Attribute.Private;
    News_Slug: Schema.Attribute.UID<'News_Title'> & Schema.Attribute.Required;
...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Show_Episodes: Schema.Attribute.Relation<
      ...
      'api::episode.episode'
    >;
    Show_Instagram: Schema.Attribute.String;
    ShowDescription: Schema.Attribute.Blocks;
    ShowImage: Schema.Attribute.Media<'images' | 'files'>;
    ShowName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ShowSlug: Schema.Attribute.UID<'ShowName'> & Schema.Attribute.Required;
    StaffComments: Schema.Attribute.Blocks & Schema.Attribute.Private;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WebLink1: Schema.Attribute.String;
    WebLink2: Schema.Attribute.String;
  };
}
...
export interface ApiTagThemeTagTheme extends Struct.CollectionTypeSchema {
  collectionName: 'tag_themes';
  info: {
    displayName: 'Tag_Theme';
    pluralName: 'tag-themes';
    singularName: 'tag-theme';
  };
  options: {
    draftAndPublish: true;
  };
